if not _G.CriminalityInfo then
    _G.CriminalityInfo = {
        SilentAimColor = Color3.fromRGB(247, 192, 189),
        ESPColor = Color3.fromRGB(247, 192, 189)
    }
end

if not _G.AccentColors then
    _G.AccentColors = {
        Accent1 = Color3.fromRGB(247, 192, 189),
        Accent2 = Color3.fromRGB(247, 192, 189)
    }
end
...
library.theme = {
    ...
    backgroundcolor = Color3.fromRGB(21, 22, 22),
    tabstextcolor = Color3.fromRGB(24, 24, 37),
